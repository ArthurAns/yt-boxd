...
function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[70vh] px-4">
      <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-lg p-8 w-full max-w-sm text-center">
        <h1 className="text-2xl font-bold mb-2">Sign in to YTBoxd</h1>
